...
- [ ] T001 Renomear `src/design-system/` para `src/legacy-design-system/`
...
- [ ] T008 [P] Baixar e adicionar Fira Code fonts (Regular, Medium) em `assets/fonts/`
...
- [ ] T025 [P] [US3] Criar arquivo `src/design-system/theme/theme.ts` com objetos darkTheme e lightTheme usando tokens cyan/gray
- [ ] T026 [US3] Criar arquivo `src/design-system/theme/ThemeProvider.tsx` com Context provider, font loading (expo-font), AsyncStorage persistence, splash screen management
- [ ] T027 [P] [US3] Criar arquivo `src/design-system/theme/useTheme.ts` com hook consumindo ThemeContext
- [ ] T028 [P] [US3] Criar arquivo `src/design-system/theme/index.ts` com barrel export
