/**
 * Interface do repositório Inbox (Port)
 *
 * Define o contrato entre o domínio e a camada de infraestrutura.
 * A implementação concreta (InboxSqliteRepo) fica em src/infra/.
 */
